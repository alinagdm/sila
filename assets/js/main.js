    ...
    $offcanvasNav.on('click', 'li a, li .menu-expand', function (e) {
        ...
        if (
            ...
            if ($subMenu.is(':visible')) {
                ...
                $offcanvasNavSubMenu.slideUp('slow');
                $offcanvasNavSubMenu.parent().removeClass('menu-open');
...
-------------------------------- */
	...
	$(document).ready(function() {
		SliderSwap(); // Вызываем функцию SliderSwap после загрузки документа
	});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var videoId = thumbnail.dataset.id;
    thumbnail.addEventListener("click", function () {
        ...
        document.getElementById("youtube-video").innerHTML = ''; // Очищаем контейнер для видео
        document.getElementById("youtube-video").appendChild(iframe);
        document.getElementById("videoModal").style.display = "block"; // Показываем модальное окно
    });
